  ...
  return (
    <footer className="border-t border-neutral-200 py-10">
      <div className="max-w-5xl mx-auto px-6 md:px-10 flex flex-col md:flex-row items-center justify-between gap-4">
        <p className="text-sm text-neutral-400 font-mono">{t.footer.copyright}</p>
        ...
        <div className="flex items-center gap-6">
          ...
          <a
            ...
            className="text-sm text-neutral-400 hover:text-neutral-900 transition-colors duration-150 font-mono"
          >
            angelserrano143@gmail.com
          </a>
        </div>
      </div>
    </footer>
